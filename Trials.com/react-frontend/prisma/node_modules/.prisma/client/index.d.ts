...
export namespace Prisma {
  ...
  */
  ...
  export type AggregateInformation = {
    ...
    count: InformationCountAggregateOutputType | null
    _avg: InformationAvgAggregateOutputType | null
    avg: InformationAvgAggregateOutputType | null
    _sum: InformationSumAggregateOutputType | null
    sum: InformationSumAggregateOutputType | null
    _min: InformationMinAggregateOutputType | null
    min: InformationMinAggregateOutputType | null
    _max: InformationMaxAggregateOutputType | null
    max: InformationMaxAggregateOutputType | null
  }
  ...
  export type InformationAggregateArgs = {
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<informationOrderByInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
    ...
    **/
     ...
     * @deprecated since 2.23.0 please use `_count`
    **/
    count?: true | InformationCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to average
    **/
     ...
     * @deprecated since 2.23.0 please use `_avg`
    **/
    avg?: InformationAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
     ...
     * @deprecated since 2.23.0 please use `_sum`
    **/
    sum?: InformationSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
     ...
     * @deprecated since 2.23.0 please use `_min`
    **/
    min?: InformationMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
     ...
     * @deprecated since 2.23.0 please use `_max`
    **/
    max?: InformationMaxAggregateInputType
  }
  ...
  type GetInformationGroupByPayload<T extends InformationGroupByArgs> = Promise<
    Array<
  ...
  export type informationGetPayload<
    S extends boolean | null | undefined | informationArgs,
    U = keyof S
      > = S extends true
        ? information
    : S extends undefined
    ? never
    : S extends informationArgs | informationFindManyArgs
    ?'include' extends U
    ? information 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof information ?information [P]
  : 
     never
  } 
    : information
  ...
  export interface informationDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'information'> extends True ? CheckSelect<T, Prisma__informationClient<information>, Prisma__informationClient<informationGetPayload<T>>> : CheckSelect<T, Prisma__informationClient<information | null >, Prisma__informationClient<informationGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'information'> extends True ? CheckSelect<T, Prisma__informationClient<information>, Prisma__informationClient<informationGetPayload<T>>> : CheckSelect<T, Prisma__informationClient<information | null >, Prisma__informationClient<informationGetPayload<T> | null >>
     ...
     * 
     * // Only select the `email`
     * const informationWithEmailOnly = await prisma.information.findMany({ select: { email: true } })
     * 
    **/
    findMany<T extends informationFindManyArgs>(
      args?: SelectSubset<T, informationFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<information>>, PrismaPromise<Array<informationGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__informationClient<information>, Prisma__informationClient<informationGetPayload<T>>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, InformationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetInformationGroupByPayload<T> : Promise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__informationClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export type informationFindUniqueArgs = {
    /**
    ...
    **/
    ...
    /**
     * Throw an Error if a information can't be found
     * 
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
   ...
   */
  export type informationFindFirstArgs = {
    /**
     * Select specific fields to fetch from the information
     * 
    **/
  ...
  export type runsScalarWhereWithAggregatesInput = {
    ...
    ninjaPoints?: FloatNullableWithAggregatesFilter | number | null
    ninjaLevel?: FloatWithAggregatesFilter | number
